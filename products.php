...
<section class="flex flex-col sm:flex-row flex-wrap justify-center gap-4 w-full h-full p-4 md:px-[8rem]">
  ...
  for($i=0; $i<count($arr['id']); $i++){
    echo '<div class="flex justify-center sm:w-[216px] h-60 overflow-clip ">
    <a class="flex flex-col items-center gap-2 w-[69%] sm:w-[216px] sm:w-auto h-full sm:h-60 px-8 sm:px-auto p-4 border-2 border-gray-500 rounded-xl" href="product.php?i='. $arr['id'][$i] .'">';
    ...
    echo '</div>
    <div class="font-sans font-medium text-lg text-center">'. $arr['name'][$i] .'</div>
